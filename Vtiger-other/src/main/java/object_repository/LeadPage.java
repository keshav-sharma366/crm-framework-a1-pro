...
public class LeadPage {
	...
	@FindBy(name = "annualrevenue")//edited
	...
	@FindBy(xpath = "//input[@title='Save [Alt+S]']")//edited
	private WebElement saveButton;

	@FindBy(xpath = "//input[@title='Cancel [Alt+X]']")//edited
