...
public class VendorPage {
	...
	@FindBy(xpath = "//input[@name='website']")//edited (id = "website")
	private WebElement website;

	@FindBy(id = "fax")
	private WebElement fax;

	@FindBy(name = "glacct")//edited
	private WebElement glAccount;

	// ===== Address Fields =====

	@FindBy(name = "street")//edited
	...
	@FindBy(xpath = "//input[@title='Save [Alt+S]']")//edited (className = "save")
	private WebElement saveButton;

	@FindBy(xpath = "//input[@title='Cancel [Alt+X]']")//edited (className = "cancel")
